            ...
            <div className={`mx-auto max-w-7xl px-5 sm:px-8 py-3 rounded-full flex justify-between items-center transition-all duration-300 ${
                ...
                <div className="flex items-center gap-3">
                    <a
                        ...
                        className="flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/5 border border-white/10 hover:border-[var(--primary)]/40 transition-all text-xs font-bold text-slate-300 shadow-sm"
