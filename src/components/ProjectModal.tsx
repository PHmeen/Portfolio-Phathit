...
export const ProjectModal: React.FC<ProjectModalProps> = ({ project, onClose, t }) => {
    ...
    const title = transItem?.title || project.title;
    const longDescription = transItem?.longDescription || project.longDescription || project.description;
    const features = transItem?.features || project.features || [];
